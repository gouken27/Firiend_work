#Задание: Реализовать микроигру в которой надо успеть тыкнуть по кружочку. При клике на кружочек фиксировать информацию об попаданиях счетчиком сслева сверху
